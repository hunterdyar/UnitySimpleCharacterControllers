...
public class TwinStickCharacterController : MonoBehaviour
{
    ...
    public void Fire(){
        ...
        Ray2D fireRay = new Ray2D(transform.position,mousePos-transform.position);
        //now we can raycast or whatever with this, for like, lasers.
        //Or we just use the direction (mousepos-transform.position, or maybe vice-versa? ) when firing a bullet and setting it's velocity.
    }
